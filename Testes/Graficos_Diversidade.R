						...
						for(o in selecao){
							for(p in problema){
								for(ps in pobSelecaoAleatoria){
									Origem <- str_c("C:\\Workspace\\ACO_NOVO\\src\\Testes\\Saida_Diversidade_",p,"_saidaMelhorGlobal tamColonia-",m,"_iteracoes-",n,"_selecao-",o,"_alfa-",i,"_beta-",j,"_feromonio-",k,"_ro-",l, "_SA-",ps)
